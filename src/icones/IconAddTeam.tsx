...
/**
 * IconAddTeam component
 * @param {React.SVGProps<SVGSVGElement>} props - The props for the IconAddTeam component
 * @returns {React.ReactElement} The IconAddTeam component
 */
